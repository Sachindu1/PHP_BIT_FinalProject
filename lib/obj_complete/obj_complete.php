...
<section class="content">
	<div class="container-fluid">
		<div class="block-header">
			<h2>OBJECTIVE COMPLETION PANEL </h2>
		</div>
		...
		<div class="row clearfix js-sweetalert">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					<div class="header">
						<h2> Objectives <small>Select an objective to proceed </small></h2>
					</div>
					<div class="body ">
					...
					<div class="body ">
						<form method="post" name="frm_insert" id="frm-insert" action="">
							...
							<div class="col-sm-6">
								<div class="form-group">
									<div class="form-line">
										...
										placeholder="Please choose a date..." value="<?= $selected_obj -> objective_stDate ?>" disabled>
									</div>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<div class="form-line">
										...
										placeholder="Please choose a date..." value="<?= $selected_obj -> objective_endDate ?>" disabled>
									</div>
								</div>
							</div>
							...
							<div class="demo-checkbox">
								<b>Select the tasks you have finished</b>
								<br /><br />
							<?php
							// tasks list
							...
							if (is_array($task_list)) {
                               ...
                               <br>
								...
								echo "No Tasks have been allocated";
								$obj_count = 0;
							}
							
							
							?>
							<input type="hidden" name="txt_obj_count" value="<?= $obj_count ?>" />
							<br />
							 </div>
							<div class="form-group form-float">
								<div class="form-line">
							...
							<div class="demo-switch">
								<b>Mark as Done</b><br />
                                <div class="switch">
                                    <label>NO<input type="checkbox" name="obj_done"><span class="lever"></span>YES</label>
                                </div>

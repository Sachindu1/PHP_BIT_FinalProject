			...
			<div class="card">
				...
				<div class="body ">
					<div class="body table-responsive">
						<form action="event_change.php" method="post">
...
<td>" . $states . "</td>
<td>
<button type=\"submit\" class=\"btn btn-primary btn-xs waves-effect\" value=" . $tbl_record -> event_id . " name='btn_change'>
<i class=\"material-icons\">edit</i>
</button>
<button type=\"submit\" class=\"btn btn-primary btn-xs waves-effect\" value=" . $tbl_record -> event_id . " name=\"btn_select\" formaction='emp_assin.php' >
...
<script type="text/javascript">
	function jd_add() {
		setUrl("event_controller.php?ftype=add_event");
